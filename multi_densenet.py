...
xconv3k = bn()(xconv3k)
xmerge10 = concatenate(
    [xconv3a, xconv3b, xconv3c, xconv3d, xconv3e, xconv3f, xconv3g, xconv3h, xconv3i, xconv3j, xconv3k])
...
xconv3l = bn()(xconv3l)
xmerge11 = concatenate(
    [xconv3a, xconv3b, xconv3c, xconv3d, xconv3e, xconv3f, xconv3g, xconv3h, xconv3i, xconv3j, xconv3k, xconv3l])
...
xconv3o = bn()(xconv3o)
xmerge14 = concatenate(
    [xconv3a, xconv3b, xconv3c, xconv3d, xconv3e, xconv3f, xconv3g, xconv3h, xconv3i, xconv3j, xconv3k, xconv3l,
     xconv3m, xconv3n, xconv3o])
...
xconv3p = bn()(xconv3p)
xmerge15 = concatenate(
    [xconv3a, xconv3b, xconv3c, xconv3d, xconv3e, xconv3f, xconv3g, xconv3h, xconv3i, xconv3j, xconv3k, xconv3l,
     xconv3m, xconv3n, xconv3o, xconv3p])
...
xconv3q = bn()(xconv3q)
xmerge16 = concatenate(
    [xconv3a, xconv3b, xconv3c, xconv3d, xconv3e, xconv3f, xconv3g, xconv3h, xconv3i, xconv3j, xconv3k, xconv3l,
     xconv3m, xconv3n, xconv3o, xconv3p, xconv3q])
...
xconv3r = bn()(xconv3r)
xmerge17 = concatenate(
    [xconv3a, xconv3b, xconv3c, xconv3d, xconv3e, xconv3f, xconv3g, xconv3h, xconv3i, xconv3j, xconv3k, xconv3l,
     xconv3m, xconv3n, xconv3o, xconv3p, xconv3q, xconv3r])
...
xconv3s = bn()(xconv3s)
xmerge18 = concatenate(
    [xconv3a, xconv3b, xconv3c, xconv3d, xconv3e, xconv3f, xconv3g, xconv3h, xconv3i, xconv3j, xconv3k, xconv3l,
     xconv3m, xconv3n, xconv3o, xconv3p, xconv3q, xconv3r, xconv3s])
...
xconv3t = bn()(xconv3t)
xmerge19 = concatenate(
    [xconv3a, xconv3b, xconv3c, xconv3d, xconv3e, xconv3f, xconv3g, xconv3h, xconv3i, xconv3j, xconv3k, xconv3l,
     xconv3m, xconv3n, xconv3o, xconv3p, xconv3q, xconv3r, xconv3s, xconv3t])
...
xconv4k = bn()(xconv4k)
xmerge10 = concatenate(
    [xconv4a, xconv4b, xconv4c, xconv4d, xconv4e, xconv4f, xconv4g, xconv4h, xconv4i, xconv4j, xconv4k])
xconv4l = Conv3D(24, (kernel_size, kernel_size, kernel_size), activation='relu', padding='same',
                 kernel_regularizer=regularizers.l2(l2_lambda))(xmerge10)
xconv4l = bn()(xconv4l)
xmerge11 = concatenate(
    [xconv4a, xconv4b, xconv4c, xconv4d, xconv4e, xconv4f, xconv4g, xconv4h, xconv4i, xconv4j, xconv4k, xconv4l])
...
xconv5k = bn()(xconv5k)
xmerge10 = concatenate(
    [xconv5a, xconv5b, xconv5c, xconv5d, xconv5e, xconv5f, xconv5g, xconv5h, xconv5i, xconv5j, xconv5k])
xconv5l = Conv3D(48, (kernel_size, kernel_size, kernel_size), activation='relu', padding='same',
                 kernel_regularizer=regularizers.l2(l2_lambda))(xmerge10)
xconv5l = bn()(xconv5l)
xmerge11 = concatenate(
    [xconv5a, xconv5b, xconv5c, xconv5d, xconv5e, xconv5f, xconv5g, xconv5h, xconv5i, xconv5j, xconv5k, xconv5l])
...
finalmerge = (
    merge([flatten1, flatten2, flatten3, flatten4, flatten5, flatten7, flatten8, flatten9, flatten10], mode='concat'))
...
finalmodel = Model(inputs=[inputthree, inputthree1],
                   outputs=[output1, output2, output4, output5, output7, output8, output9, output10,
                            output])  # This line assigns the model name to the model
