...
def random_noise(data: np.ndarray, stdev: float = 0.004) -> np.ndarray:
    """ Introduces random noise generated by a gaussian with a given standard deviation

    :param data: The numpy array which is to be altered
    :param stdev: Standard deviation of the noise
    :return: numpy array with noise
    """
...
def random_brightness(data: np.ndarray, factor: float=0.35) -> np.ndarray:
    """ Alters the brigthness of the input by a given factor
    
    :param data: numpy array
    :param factor: float which indicates the maximum alteration of the array
    :return: numpy array with changed brightness
    """
...
def alt_random_rotate(data: np.ndarray):
    """ Rotates the matrix in all directions for 0-4 times.
